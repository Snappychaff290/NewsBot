...
class NewsSummarizer:
    ...
    def generate_response(self, user_message: str, relevant_articles: list = None, context: str = "") -> str:
        ...
        try:
            ...
            - When referencing dates or timeframes, use the current date provided above as your reference point
    ...
    def select_relevant_articles(self, user_question: str, all_articles: list, max_articles: int = 10) -> list:
        ...
        try:
            ...
            for article in all_articles:
                ...
                articles_list += f"ID: {article['id']} | Source: {article.get('source', 'Unknown')} | Title: {article['title']}{published_info}\n"
            ...
            4. Consider recency, topic relevance, and source diversity when selecting
    ...
    def generate_response_with_selected_articles(self, user_message: str, selected_articles: list, context: str = "") -> str:
        ...
        try:
            ...
            - Provide article URLs for users to read more if they want
            - When referencing dates or timeframes, use the current date provided above as your reference point
            ...
            response = self.client.chat.completions.create(
                model=self.model,
                messages=[
                    {"role": "system", "content": "You are a highly intelligent, no-nonsense assistant who reads and summarizes news with clarity, skepticism, and integrity. You value truth over approval, facts over feelings, and honest conversation over scripted talking points. You speak plainly, think critically, and never condescend. When answering questions, synthesize information from the provided articles to give comprehensive, well-sourced responses."},
                    {"role": "user", "content": prompt}
                ],
                max_tokens=800,
                temperature=0.7
